...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Scaffold(
        appBar: AppBar(title: const Text('Shopping List', textDirection: TextDirection.ltr,)),
        body:  const Center(child: Text('data',  textDirection: TextDirection.ltr,),)
      ),
    );
  }
}
